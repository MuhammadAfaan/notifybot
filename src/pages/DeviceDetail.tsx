      ...
      <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-xl font-semibold">
            Device: <span className="text-gray-500 text-base">eed31112-7dc9-4c06-857e-2289c442a0d3</span>
          </h1>
          <Link to="/devices">
              ...
              <div className="space-y-12">
                <div>
                  <div className="flex items-center gap-2 mb-1">
                    <Smartphone size={16} className="text-notifybot-blue" />
                ...
                <div>
                  <div className="flex items-center gap-2 mb-1">
                    <Settings size={16} className="text-notifybot-blue" />
                ...
                <div>
                  <div className="flex items-center gap-2 mb-1">
                    <Link2 size={16} className="text-notifybot-blue" />
